...
namespace fmiVis {
	...
	//applies the icon information to point data
	...
	/*
	vtkExtractSelectedIds subsamples the grid and a vtkProgrammableAttributeDataFilter is used to insert the icon information into the pipeline
	*/
