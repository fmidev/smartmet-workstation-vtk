...
// Jos kyse on asemadatasta, voi olla useita data lähteitä ja niillä voi olla erilaiset viimeiset ajat,
// tällöin valitaan viimeinen aika prioriteetti 1 datasta.
// Lisäksi asemadata pitää hilata, jossa käytetään emoluokan ominaisuuksia.
...
protected:
    ...
    // Tähän haetaan asemadata tapauksissa sopiva viimeinen aika riippuen siitä onko kyseessä yksi vai useampi datalähteitä.
